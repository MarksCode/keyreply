...
window.onload = function() {
    ...
    $('.keyreply-chat-icon').each(function(index, icon) {
        ...
        switch (app.data('type')) {
            ...
            case 'whatsapp':
                qr = $('<div>').text("This is our phone number. Add us on whatsapp." + settings.apps.whatsapp)
